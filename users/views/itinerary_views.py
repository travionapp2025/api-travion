        ...
        for segment_data in segments_data:
            ...
            for provider_segment in provider_segments:
                ...
                matches.append({
                    ...
                    'departure_date_from': provider_segment.departure_date_from.isoformat() if provider_segment.departure_date_from else None,
                    'departure_date_to': provider_segment.departure_date_to.isoformat() if provider_segment.departure_date_to else None,
            ...
            for match in matches:
                ...
                if match_type == 'provider_seeker':
                    ...
                    serialized_matches.append({
                        ...
                        'departure_date_from': match.get('departure_date_from'),
                        'departure_date_to': match.get('departure_date_to'),
